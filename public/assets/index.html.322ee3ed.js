import{_ as t,r as o,a as r,d as e,w as a,F as p,b as s,e as n,o as i}from"./app.135dab7f.js";const d={},u=s("h3",{id:"as-easy-as-1-2-3",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#as-easy-as-1-2-3","aria-hidden":"true"},"#"),n(" As Easy as 1, 2, 3")],-1),y=s("div",{class:"language-bash ext-sh"},[s("pre",{class:"shiki",style:{"background-color":"#22272e"}},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#768390"}},"# Install required software")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#6CB6FF"}},"echo"),s("span",{style:{color:"#ADBAC7"}}," "),s("span",{style:{color:"#96D0FF"}},'"deb [signed-by=/usr/share/keyrings/n.wtf.asc] https://mirror-cdn.xtom.com/sb/nginx/ $(lsb_release -sc) main"'),s("span",{style:{color:"#ADBAC7"}}," "),s("span",{style:{color:"#F47067"}},">"),s("span",{style:{color:"#ADBAC7"}}," /etc/apt/sources.list.d/n.wtf.list")]),n(`
`),s("span",{class:"line"}),n(`
...
`),s("span",{class:"line"})])])],-1);function _(A,C){const l=o("CodeGroupItem"),c=o("CodeGroup");return i(),r(p,null,[u,e(c,null,{default:a(()=>[e(l,{title:"Debian / Ubuntu",active:""},{default:a(()=>[y]),_:1}),e(l,{title:"Docker"},{default:a(()=>[g]),_:1}),e(l,{title:"Docker Compose"},{default:a(()=>[h]),_:1})]),_:1})],64)}var x=t(d,[["render",_]]);export{x as default};
